...
import { setupGlobalInterceptors } from './utils/axiosInterceptor'
import './App.css'
          ...
          <Provider store={store}>
            <Router>
              <Routes>
                ...
                <Route
                  path='/bulkuploadhistory'
                  element={<BulkUploadHistory />}
                ></Route>
                <Route
                  path='/quotetrackingdashboard'
                  element={<QuoteTrackingDashboard />}
                ></Route>
